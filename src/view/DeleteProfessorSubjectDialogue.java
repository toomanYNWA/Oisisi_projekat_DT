...
public class DeleteProfessorSubjectDialogue extends JDialog{
	
	public DeleteProfessorSubjectDialogue(Subject subject,Professor professor) {
		setModal(true);
		setSize(300,150);
		...
		doo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
					//
				SubjectsController.getInstance().deleteSP(subject, professor);
				ProfesorSubjectsTable.updateProfessorSubjectsTable();
					dispose();
